...
class NavigationHandler implements DashboardComponent {
    ...
    private handleNavClick(clickedItem: HTMLElement): void {
        ...
        if (section === 'triage') {
            this.showSection('triage-section');
            this.hideSection('student-list-section');
        } else {
            this.showSection('student-list-section');
            this.hideSection('triage-section');
        }
...
class Dashboard {
    ...
    public initialize(): void {
        ...
        // Initialize Triage handler if available
        if ((window as any).TriageHandler) {
            const triageHandler = new (window as any).TriageHandler();
            triageHandler.initialize();
            this.components.push(triageHandler);
        }
